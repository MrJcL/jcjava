	...
	<body>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				 $.post("pic3.action",function(data){
            var div=$("<div class='row'></div>");
            $.each(data,function(index,item){
                var tr1=$("<div class='col-md-4'><div class='thumbnail'><img alt='300x200' style='width: 300px; height: 200px' src='"+item.picurl+"' /><div class='caption'><h2>"+item.pictitle+"</h2><p>"+item.picinfo+"</p><p><a class='btn btn-primary' href='/Struts2Demo3/delete3.action?pictitlename="+item.pictitle+"'>删除</a></p></div></div></div>");
                div.append(tr1);
            });
            $("body").append(div);
        },"json");
